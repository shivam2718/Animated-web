...
function Eyes() {
  ...
  return (
    <div  className=' eyes w-full h-screen overflow-hidden'>
        <div data-scroll data-scroll-speed="-.8"  className=" relative bg-cover bg-center w-full h-full bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg')] ">
          ...
          <div className=' flex items-center justify-center w-[15vw] h-[15vw] bg-zinc-100 rounded-full'>
            ...
            <div className='blackthing relative w-2/3 h-2/3 bg-zinc-900 rounded-full'>
